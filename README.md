...
* Smooth Turn support.  Press **L3+R3** to open up the UEVR overlay.  Select the "Input" tab and set the "Snap Turn Angle" to 359 (for Meta, Index, and HTC controllers) or 2 (for Pimax controllers).  This enables smooth turning for seated play.
